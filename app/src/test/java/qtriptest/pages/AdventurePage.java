...
public class AdventurePage {
    ...
    public void setCategoryValue(String category_value){
        try{
            if (verifyPresenceOfCategoryFilterDropdown()){
                ...
                SeleniumWrapper.click(category_Dropdown, driver);
        ...
        try{
            ...
            for(int i=1;i<= category.size(); i++){
                if(category.get(i).getText().contains(categoryFilter)){
                    ...
                    SeleniumWrapper.click(category.get(i), driver);
    ...
    public void setFilterValue(String duration_Filter ){
        try { 
            if (verifyPresenceOfDurationFilterDropdown()) {
                ...
                SeleniumWrapper.click(duration_Dropdown, driver);
        ...
        try{
            ...
            for(int i=1; i<= duration.size(); i++) {
                if(duration.get(i).getText().contains(duration_Filter)) {
                    ...
                    SeleniumWrapper.click(duration.get(i), driver);
                    Thread.sleep(1000);
                    break;
                }
            } 
    ...
    public void clearFilterValue(){
        ...
        SeleniumWrapper.click(duration_Filter_Clear_Button, driver);
        SeleniumWrapper.click(category_Filter_Clear_Button, driver);
        SeleniumWrapper.click(search_Filter_Clear_Button, driver);
    }
        ...
        public void selectAdventure(String AdventureName) throws InterruptedException{
            ...
            SeleniumWrapper.click(searchAdventureTxtBox, driver);
            //WebDriverWait wait = new WebDriverWait(driver, 20);
            //wait.until(ExpectedConditions.visibilityOf(searchAdventureTxtBox));
            // searchAdventureTxtBox.sendKeys(AdventureName);
            SeleniumWrapper.sendKeys(searchAdventureTxtBox, AdventureName);
            Thread.sleep(2000);
            // search_adventure_Detail.click();
            SeleniumWrapper.click(search_adventure_Detail, driver);
